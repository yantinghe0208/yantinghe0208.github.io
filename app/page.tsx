      ...
      <section className="hero hero-home" aria-labelledby="hero-title">
        ...
        <div className="hero-copy">
          ...
          <p className="intro research-focus">
            ...
            creators, consumers, brands and platforms interact, and how these
            interactions shape markets and society. My goal is to generate
            insights that support a more transparent, equitable, and effective
            digital ecosystem.
          </p>
